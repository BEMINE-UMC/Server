...
| 회원가입 및 로그인, 인증 기능(이메일 인증, 비밀번호 재설정), 게시물 조회(좋아요, 다른 게시물) | 기능2 | 기능3 | - 연혁 조회<br/> - 최근 본 게시물 조회<br/> -북마크한 게시물 조회<br/> - 프로필 수정<br/> -템플릿 수정<br/> - 템플릿 생성<br/> - 연혁 생성<br/> - 사용자 정보 조회<br/> - 자기소개 수정 | 게시물 목록 조회, 템플릿 목록 조회, 템플릿 단일 조회(업로드 화면, 파일 조회 창), 템플릿 삭제 |
